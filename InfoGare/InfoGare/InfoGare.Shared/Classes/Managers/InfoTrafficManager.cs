...
{
    public static class InfoTraffic
    {
        public static InfoTrafficPresenter GetDefaultInfo()
        {
            ...
            return new InfoTrafficPresenter { ImportanceColor = "FF043a6b", Title = "Attentifs, ensemble", Description = rInfo[Utilities.GetRandom(0, rInfo.Count())] };
        }
