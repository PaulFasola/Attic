...
namespace Infoécran.Controls
{
    public sealed partial class DetailedDessertePanel : global::Windows.UI.Xaml.Controls.UserControl
    {
        ...
        {  
            ...
            var maxSize = Dessertes.ActualHeight;

            if (ApplicationView.GetForCurrentView().Orientation.ToString() != "Portrait")
            {
                InitPortaitMode(stack); // en attendant
            }
            else
            {
