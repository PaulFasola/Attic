...
namespace Infoécran.AppStates
{
    ...
    public sealed partial class DetailedMissionState : Page
    {
        ...
        private bool _scrollableTransitionRunning;
        private Tuple<InfoGare, string, GareSuggestionPresenter> _BackData;
        ...
        {
            var inbound = e.Parameter as Tuple<Mission, InfoTrafficPresenter, Tuple<InfoGare, string, GareSuggestionPresenter>>;
        ...
        public bool _BackScrollTranslationRunning { get; set; }

        public bool _backScrollTranslationInitialized { get; set; }
